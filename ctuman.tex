...
%	supervisor-address = {Ústav X, \\ Uliční 5, \\ Praha 99},
	keywords-czech = {robotika, počítačové vidění, řízení robotu, korelace, ArUco, PID, VFH, V-Rep},
	keywords-english = {robotics, computer vision, robot control, correlation, ArUco, PID, VFH, V-Rep},
	day = \the\day,
	month = \the\month,
	year = \the\year,
...
\begin{abstract-czech}
	V práci je probírána problematika následování člověka mobilním robotem. Pro detekci vizuální značky, dle které je člověk sledován, jsou použity korelační algoritmus a detektor ArUco markerů. Pro řízení robotu je použit diskrétní PID regulátor. Také je použit algoritmus Vector Field Histogram pro vyhýbání se překážkám. Software byl vyzkoušen v simulátoru V-Rep a také na reálném robotu.
\end{abstract-czech}
...
\begin{thanks}
	...
	Zvláštní poděkování patří také mé rodině a blizkým za jejich podporu během celého studia.
\end{thanks}
...
\begin{table}[hbt]
	\centering
	\caption{Souhrn základních algoritmů pro vyhýbání se překážkám \newline\cite[s. 287--290]{cite:20}}
	\label{obstacle_avoidance}
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		\cellcolor[HTML]{C0C0C0}                         & \cellcolor[HTML]{C0C0C0}                             & \cellcolor[HTML]{C0C0C0}                                   & \cellcolor[HTML]{C0C0C0}                                           & \cellcolor[HTML]{C0C0C0}                                   \\
		\multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}Metoda} & \multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}Kinemtaika} & \multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}Pohled}           & \multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}Mapa}                     & \multirow{-2}{*}{\cellcolor[HTML]{C0C0C0}Senzor}           \\ \hline
		Bug                                              & Žádná                                                & Lokální                                                    & \begin{tabular}[c]{@{}c@{}}Žádná\\ Lokální graf tečen\end{tabular} & \begin{tabular}[c]{@{}c@{}}Dotykový\\ Dálkový\end{tabular} \\ \hline
		VFH                                              & Záklaní                                              & Lokální                                                    & Mřížoví histogram                                                  & Dálkový                                                    \\ \hline
		Bubble band                                      & Přesná                                               & \begin{tabular}[c]{@{}c@{}}Lokální\\ Globální\end{tabular} & Globální polygon                                                   & Různé                                                      \\ \hline
